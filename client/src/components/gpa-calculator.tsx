...
import { DepartmentMajorSelection } from "./department-major-selection";
...
export function GPACalculator() {
  ...
  useEffect(() => {
    if (userRecord) {
      setSelectedDepartment(userRecord.departmentId || "");
      setSelectedMajor(userRecord.majorId || "");
  ...
  }, [selectedDepartment, selectedMajor, semesters]);
        ...
        <Card className="mb-8">
          <CardContent className="p-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">Select your department, major, and add your courses to calculate your cumulative and semester GPA</p>
            </div>
          </CardContent>
        </Card>

        {/* Department and Major Selection */}
        <DepartmentMajorSelection
